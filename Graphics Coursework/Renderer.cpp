...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	test->SetTexture(SOIL_load_OGL_texture(TEXTUREDIR "brick.tga", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0));
...
void Renderer::DrawFloor() {
	...
	glUniform1i(glGetUniformLocation(currentShader->GetProgram(), "bumpTex"), 1);
	//glUniform1i(glGetUniformLocation(currentShader->GetProgram(), "cubeTex"), 2);
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "tli"), 2048);
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "tlo"), 2048);
